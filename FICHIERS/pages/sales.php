...
<body>
    <?php
        ...
        // Bouton de la page promotion
        echo "<button class='button'><h1>PROMOTIONS</h1></button>";

        // Contenu de la page promotion
        ...
        echo '<h2>Produits en promotion</h2>';
        foreach ($products as $product) {
            if ($product['promotions']) {
                echo '<div class="product">';
                echo '<h3>' . $product['designation'] . '</h3>';
                echo '<p>Catégorie : ' . $product['categorie'] . '</p>';
                echo '<p>Modèle : ' . $product['modele'] . '</p>';
                echo '<p>Prix : ' . $product['prix'] . '€</p>';
                echo '<p>Promotions : ' . ($product['promotions'] ? 'Oui' : 'Non') . '</p>';
